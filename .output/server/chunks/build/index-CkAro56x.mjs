import { m as makeComponentProps, u as useRender, a as makeRoundedProps, b as makeElevationProps, R as Ripple, c as useElevation, d as useTextColor, e as useRounded, f as useBackgroundColor, g as makeTransitionProps$1, h as makeDensityProps, i as makeDimensionProps, j as useDensity, k as useDimension, l as makeLoaderProps, n as useLoader, I as Intersect, V as VApp, o as VContainer, M as MaybeTransition, L as LoaderSlot, p as VDefaultsProvider, q as useFormStore, r as VBtn, s as VIcon, _ as __nuxt_component_0 } from './VContainer-CMUemt5-.mjs';
import { ref, inject, computed, createVNode, toRef, watch, useSSRContext, provide, onScopeDispose, shallowRef, watchEffect, defineComponent, withCtx, resolveDynamicComponent, toDisplayString, openBlock, createBlock, markRaw, TransitionGroup, Transition, h, camelize, withDirectives, resolveDirective, vShow, unref, mergeProps, Fragment, cloneVNode, createTextVNode, nextTick, vModelText } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderVNode, ssrGetDirectiveProps } from 'vue/server-renderer';
import { p as propsFactory, g as genericComponent, j as useRtl, m as convertToUnit, w as wrapInArray, I as IconValue, E as EventProp, y as only, z as makeThemeProps, A as provideTheme, t as getUid, e as useProxiedModel, G as deepEqual, H as provideDefaults, K as omit, f as consoleWarn, h as getDecimals, k as createRange, q as useLocale, s as getCurrentInstanceName, v as getCurrentInstance, x as useToggleScope, D as filterInputAttrs, l as clamp, B as isOn, C as pick, F as callEvent, J as matchesSelector, o as keyValues } from './server.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const rules = {
      name: (value) => /^[A-Za-z]+$/.test(value) || "Povolena jsou pouze p\xEDsmena.",
      dateOfBirth: (value) => {
        const datePattern = /^(0[1-9]|[12][0-9]|3[01])\.(0[1-9]|1[0-2])\.(19|20)\d{2}$/;
        if (!datePattern.test(value)) {
          return "Datum mus\xED b\xFDt ve form\xE1tu DD.MM.YYYY.";
        }
        const [day, month, year] = value.split(".").map(Number);
        const date = new Date(year, month - 1, day);
        if (date.getFullYear() !== year || date.getMonth() !== month - 1 || date.getDate() !== day) {
          return "Neplatn\xE9 datum.";
        }
        return true;
      }
    };
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VForm, mergeProps({
        ...
        "onUpdate:modelValue": ($event) => isFormValid.value = $event,
        class: "space-y-4"
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VSlider, {
              modelValue: unref(formStore).investmentAmount,
              "onUpdate:modelValue": ($event) => unref(formStore).investmentAmount = $event,
              label: "Pravideln\xE1 v\xFD\u0161e investice v CZK",
              max: 1e5,
              min: 500,
              "thumb-label": "always"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(VTextField, {
              modelValue: unref(formStore).name,
              "onUpdate:modelValue": ($event) => unref(formStore).name = $event,
              label: "Jm\xE9no",
              rules: [rules.name]
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(VTextField, {
              modelValue: unref(formStore).surname,
              "onUpdate:modelValue": ($event) => unref(formStore).surname = $event,
              label: "P\u0159\xEDjmen\xED",
              rules: [rules.name]
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(VTextField, mergeProps({
              modelValue: unref(formStore).dateOfBirth,
              "onUpdate:modelValue": ($event) => unref(formStore).dateOfBirth = $event,
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/step1.vue");
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const rules = {
      telephone: (value) => /^\+\d{3} \d{3} \d{3} \d{3}$/.test(value) || "Neplatn\xFD form\xE1t. Pou\u017Eijte +123 123 456 789.",
      email: (value) => /.+@.+\..+/.test(value) || "Neplatn\xE1 e-mailov\xE1 adresa.",
      ssn: (value) => /^\d{6}\/\d{4}$/.test(value) || "Neplatn\xFD form\xE1t. Pou\u017Eijte 123456/1234",
      identityCard: (value) => /^\d{9}$/.test(value) || "Neplatn\xFD form\xE1t. Pou\u017Eijte 123456789"
    };
    return (_ctx, _push, _parent, _attrs) => {
      const _directive_mask = resolveDirective("mask");
      _push(ssrRenderComponent(VForm, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VTextField, mergeProps({
              modelValue: unref(formStore).telephone,
              "onUpdate:modelValue": ($event) => unref(formStore).telephone = $event,
              label: "Telefonn\xED \u010D\xEDslo",
              placeholder: "+420 123 456 789",
              rules: [rules.telephone]
            }, ssrGetDirectiveProps(_ctx, _directive_mask, "+### ### ### ###")), null, _parent2, _scopeId));
            _push2(ssrRenderComponent(VTextField, {
              modelValue: unref(formStore).email,
              "onUpdate:modelValue": ($event) => unref(formStore).email = $event,
              label: "Emailov\xE1 adresa",
              rules: [rules.email]
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(VTextField, mergeProps({
              modelValue: unref(formStore).socialSecurityNumber,
              "onUpdate:modelValue": ($event) => unref(formStore).socialSecurityNumber = $event,
              label: "Rodn\xE9 \u010D\xEDslo",
              placeholder: "123456/1234",
              rules: [rules.ssn]
            }, ssrGetDirectiveProps(_ctx, _directive_mask, "######/####")), null, _parent2, _scopeId));
            _push2(ssrRenderComponent(VTextField, mergeProps({
              modelValue: unref(formStore).identityCardNumber,
              "onUpdate:modelValue": ($event) => unref(formStore).identityCardNumber = $event,
              label: "\u010C\xEDslo ob\u010Dansk\xE9ho pr\u016Fkazu",
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/step2.vue");
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const rules = {
      required: (value) => !!value || "Toto pole je povinn\xE9.",
      iban: (value) => /^[A-Z]{2}\d{2} \d{4} \d{4} \d{4} \d{4} \d{4}$/.test(value) || "Neplatn\xFD form\xE1t IBAN. Pou\u017Eijte CZ12 0800 0000 0000 0000 0000"
    };
    return (_ctx, _push, _parent, _attrs) => {
      const _directive_mask = resolveDirective("mask");
      _push(ssrRenderComponent(VForm, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VTextarea, {
              modelValue: unref(formStore).address,
              "onUpdate:modelValue": ($event) => unref(formStore).address = $event,
              label: "Adresa trval\xE9ho pobytu",
              rules: [rules.required]
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(VTextField, mergeProps({
              modelValue: unref(formStore).bankAccountNumber,
              "onUpdate:modelValue": ($event) => unref(formStore).bankAccountNumber = $event,
              label: "\u010C\xEDslo bankovn\xEDho \xFA\u010Dtu",
              placeholder: "CZ12 0800 0000 0000 0000 0000",
              rules: [rules.iban]
            }, ssrGetDirectiveProps(_ctx, _directive_mask, "AA## #### #### #### #### ####")), null, _parent2, _scopeId));
            _push2(ssrRenderComponent(VCheckbox, {
              modelValue: unref(formStore).consent,
              "onUpdate:modelValue": ($event) => unref(formStore).consent = $event,
              label: "Souhlas se zpracov\xE1n\xEDm osobn\xEDch \xFAdaj\u016F",
              rules: [rules.required]
            }, null, _parent2, _scopeId));
            _push2(`<div class="flex justify-between"${_scopeId}>`);
            _push2(ssrRenderComponent(VBtn, {
              onClick: __props.goBack,
              color: "secondary"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/step3.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const steps = [_sfc_main$3, _sfc_main$2, _sfc_main$1];
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VContainer, { class: "flex justify-center items-center min-h-screen px-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 md:p-8"${_scopeId3}><h2 class="text-2xl md:text-3xl font-bold text-center text-gray-800 mb-6"${_scopeId3}> Investov\xE1n\xED m\xE1te v kapse - v mobilu, doma i na cest\xE1ch. </h2><h3 class="text-xl md:text-2xl font-semibold text-center text-gray-700 mb-4"${_scopeId3}> Krok ${ssrInterpolate(currentStep.value + 1)} z 3 </h3>`);
                        ssrRenderVNode(_push4, createVNode(resolveDynamicComponent(currentStepComponent.value), {
                          goNext,
                          goBack
                        ...
                        return [
                          createVNode("div", { class: "w-full max-w-lg bg-white shadow-lg rounded-lg p-6 md:p-8" }, [
                            createVNode("h2", { class: "text-2xl md:text-3xl font-bold text-center text-gray-800 mb-6" }, " Investov\xE1n\xED m\xE1te v kapse - v mobilu, doma i na cest\xE1ch. "),
                            createVNode("h3", { class: "text-xl md:text-2xl font-semibold text-center text-gray-700 mb-4" }, " Krok " + toDisplayString(currentStep.value + 1) + " z 3 ", 1),
                            (openBlock(), createBlock(resolveDynamicComponent(currentStepComponent.value), {
                              goNext,
                              goBack
                            }))
                          ])
...
//# sourceMappingURL=index-CkAro56x.mjs.map
