...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.Z22NsAXP.mjs').then(interopDefault),
  "plugins/vuetify.ts": () => import('./vuetify-styles.u2DKoFvE.mjs').then(interopDefault),
